...
public class SequenceController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<IActionResult> GetSequences([FromQuery] bool? includeQuestions, [FromQuery] string? search = null, [FromQuery] int? page = null, [FromQuery] int? pageSize = null)
    {
        var result = await _sequenceService.GetSequences(includeQuestions ?? true, search, page, pageSize);
